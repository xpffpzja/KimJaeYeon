...
public class Application {
    public static void main(String[] args) {
        ...
        * 확보하기 위함이다. 유연성 혹봐는 여러곳에 적용할 수 있는 유일한 객체를 의미하며, 즉, 재사용성이 높아질 수 있다는
        * 의미이다. 객체재사용성이 증가하면 중복 작성되는 코드를 줄일 수 있으며, 오류 발생 가능성을
        * 감소시키고 유지 보수성을 증가시킨다.
        * */
        ...
        *  1. 카레이서 클래스
        *   - 속성 : 자동차
        *   - 행위 : 시동 걸기, 엑셀 밟기, 브레이크 밟기, 시동끄기
        *  2. 자동차 클래스
        *   - 속성 : 시동상태, 현재 시속
        *   - 메소드 : 시동 걸기, 앞으로 가기, 멈추기, 시동 끄기
        * */
