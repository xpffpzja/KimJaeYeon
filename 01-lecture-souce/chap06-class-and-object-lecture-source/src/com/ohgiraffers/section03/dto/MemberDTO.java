...
public class MemberDTO {
    ...
    private boolean isAcativted; // 회원탈퇴여부(활성화 여부)
    ...
    public void setAcativted(boolean acativted) {
        isAcativted = acativted;
    }
    ...
    public boolean isAcativted() {
        return isAcativted;
        //boolean의 접근자는 get으로 시작하지 않고 is로 시작하는 것이 일반적인 관계이다.
    }
