...
public class Application {
    public static void main(String[] args) {
        ...
        /* 1. private에 필드에 직접 접근하여 compiler error를 봘생 확인*/
     ...
     /*   monster1.kinds = "피카츄";
        ...
        /* 캡슐화는 유지보수성을 증가시키기위해 직접 접근을 제한하고
        * public 메소드를 이용해서 간접적으로 접근하여 사용할 수 있도록 만드 기술이다.
        * 클래스 작성식 특별한 목적이 아닌 이상 캡슐화를 기본원칙으로 사용되고 있다.
        * */
    }
}
