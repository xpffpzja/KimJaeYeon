...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        * '>=" : 왼쪽의 피연산자가 오른쪽의 피연산자보다 크거나 같으면 true를 아니면 false를 반환
        ...
        * */
        ...
        System.out.println("inum1이 inum2보다 큰지비교" + (inum1 > inum2));
        ...
        System.out.println( "ch1 와 ch2가 같은지 비교" + (ch1 == ch2));
        System.out.println( "ch1 와 ch2가 다른지 비교" + (ch1 != ch2));
        ...
        System.out.println( "bool1 와 bool2가 같은지 비교" + (bool1 == bool2));
        System.out.println( "bool1 와 bool2가 다른지 비교" + (bool1 != bool2));
        ...
        System.out.println( "str1 와 str2가 같은지 비교" + (str1 == str2));
        System.out.println( "str1 와 str2가 다른지 비교" + (str1 != str2));
