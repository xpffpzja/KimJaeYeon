...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        *  1-1. &&(논리AND) 연산자 : 두 개의 논리식이 모두 참일 경우 참을 반환. 둘중에 한 개라도 거짓인 경우 거짓을 반환하는 연산자이다.
        *  1-2. ||(논리OR)(원화 + 쉬프트) 연산자 : 두 개의 논리식 중 둘 중 하나라도 참인 경우 참을 반환. 둘다 거짓일 경우 거짓을 반환하는 연산자이다.
        ...
        * */
        ...
        System.out.println("ark b보다 크면서 c가 d보다 큰지 확인:" +(a > b && c > d));
