...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        bnum = 1; //-128~ +127
        snum = 2; //-32768 ~ + 32767
        inum = 3; //-2147483648 ~ + 2147483644
        //lnum = 4; //아무 문제 없을 것 같지만 뒤에 대문자 L을 붙여야함. 그 이유는 형변환에서...
        lnum = 8L;


        /* 2-2. 실수를 취급하는 자료형 값 대입 */
        //fnum = 4.0;
        fnum = 4.0f;  //숫자뒤에 f 꼭 붙일것
        dnum = 8.0;


        /* 2-3 문자를 취급하는 자료형 값 대입 */
        ch = 'a'; //문자 형태의 값을 저장할 수 있다.
        ch2 = 97; //'a'는 '97'. 따라서 숫자로도 저장할 수 있다.


        /* 2-4 논리를 취급하는 자료형에 값 대입 */
        isTrue = true;

        System.out.println("iTrue의 값을 출력 : " + isTrue);

        isTrue = false;

        /* 2-5 문자열을 취급한느 자료형에 값 대입*/
        str = "안녕하세요";
        ...
        * */
        ...
        System.out.println("bnum의 값을 출력 : " + bnum);
        System.out.println("snum의 값을 출력 : " + snum);
        System.out.println("inum의 값을 출력 : " + inum);
        System.out.println("lnum의 값을 출력 : " + lnum);

        System.out.println("fnum의 값을 출력 : " + fnum);
        System.out.println("dnum의 값을 출력 : " + dnum);

        System.out.println("ch의 값을 출력 : " + ch);
        System.out.println("ch2의 값을 출력 : " + ch2);

        System.out.println("iTrue의 값을 출력 : " + isTrue);

        System.out.println("str의 값을 출력 : " + str);
